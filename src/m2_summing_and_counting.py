...
def run_test_sum_more_cosines():
    ...
    expected = 1.17140  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(6, 7)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 1.12415  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-2, 0)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
