...
def run_test_count_cosines_from():
    ...
    expected = 0
    answer = count_cosines_from(7, 9, 1)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(3, 5, -1)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 1
    answer = count_cosines_from(5, 6, 0.5)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.35116  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 13)
